                  ...
                  {(qForm.type==="mcq"||qForm.type==="multiple")&&(
                    <div className="input-group">
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                        ...
                        <button type="button" onClick={addOpt} style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',border:"none",borderRadius:6,padding:"4px 12px",fontSize:12,fontWeight:700,cursor:"pointer"}}>+ Добавить вариант</button>
                      </div>
                  ...
                  {qForm.type==="matching"&&(
                    <div className="input-group">
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                        ...
                        <button type="button" onClick={addPair} style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',border:"none",borderRadius:6,padding:"4px 12px",fontSize:12,fontWeight:700,cursor:"pointer"}}>+ Добавить пару</button>
                      </div>
                  ...
                  {qForm.type==="compound"&&(
                    <div className="input-group">
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
                        ...
                        <button type="button" onClick={()=>setQForm(p=>({...p,subQuestions:[...p.subQuestions,{text:"",image:"",options:["","","",""],optionImages:["","","",""],correct:0,skillNames:[],difficulty:"A"}]}))} style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',border:"none",borderRadius:6,padding:"4px 12px",fontSize:12,fontWeight:700,cursor:"pointer"}}>+ Под-вопрос</button>
                      </div>
                    ...
                    <>
                      <div className="input-group">
                        ...
                        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                          ...
                          <button type="button" onClick={()=>setQForm(p=>({...p,variables:[...p.variables,{name:"",min:1,max:10}]}))} style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',border:"none",borderRadius:6,padding:"4px 12px",fontSize:12,fontWeight:700,cursor:"pointer"}}>+ Переменная</button>
                        </div>
                      ...
                      <div className="input-group">
                        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                          ...
                          <button type="button" onClick={()=>setQForm(p=>({...p,derivedVars:[...p.derivedVars,{name:"",formula:""}]}))} style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',border:"none",borderRadius:6,padding:"4px 12px",fontSize:12,fontWeight:700,cursor:"pointer"}}>+ Вычисляемая</button>
                        </div>
                    ...
                    <div style={{display:"flex",justifyContent:"space-between",gap:16}}>
                      <div style={{flex:1}}>
                        <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:10,alignItems:"center"}}>
                          ...
                          <span style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',fontSize:11,fontWeight:700,padding:"3px 10px",borderRadius:6}}>{q.sectionName}</span>
                ...
                <form onSubmit={saveSkill}>
                  ...
                  <div className="input-group">
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                      ...
                      <button type="button" onClick={()=>setSkillForm(p=>({...p,exercises:[...p.exercises,""]}))} style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',border:"none",borderRadius:6,padding:"3px 10px",fontSize:12,fontWeight:700,cursor:"pointer"}}>+ Добавить</button>
                    </div>
                  ...
                  <div className="input-group">
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                      ...
                      <button type="button" onClick={()=>setSkillForm(p=>({...p,homework:[...p.homework,""]}))} style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',border:"none",borderRadius:6,padding:"3px 10px",fontSize:12,fontWeight:700,cursor:"pointer"}}>+ Добавить</button>
                    </div>
                  ...
                  <div key={sk.id} style={{background:"#fff",borderRadius:12,border:`1px solid ${isOrphan?"rgba(239,68,68,0.3)":THEME.border}`,padding:"14px 18px",display:"flex",gap:16,alignItems:"flex-start"}}>
                    <div style={{flex:1}}>
                      <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap",marginBottom:4}}>
                        <span style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',fontSize:11,fontWeight:700,padding:"2px 8px",borderRadius:5}}>{sk.grade||sk.sectionName}</span>
                  ...
                  return(
                    <div key={s.id} onClick={()=>openStudentModal(s)} style={{background:"#fff",borderRadius:14,border:`1px solid ${THEME.border}`,padding:"18px 20px",cursor:"pointer",transition:"all 0.2s",position:"relative"}}
                      ...
                      <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:10}}>
                        <div style={{width:40,height:40,borderRadius:"50%",background:THEME.accent,color:THEME.onAccent ?? '#0f172a',display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Montserrat',sans-serif",fontWeight:800,fontSize:14,flexShrink:0}}>{s.firstName?.[0]}{s.lastName?.[0]}</div>
              ...
              <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:9999,padding:16}} onClick={e=>{if(e.target===e.currentTarget)closeStudentModal();}}>
                <div style={{background:"#fff",borderRadius:20,padding:32,width:"100%",maxWidth:520,maxHeight:"90vh",overflowY:"auto",boxShadow:"0 20px 60px rgba(0,0,0,0.25)"}}>
                  <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:24}}>
                    <div style={{width:48,height:48,borderRadius:"50%",background:THEME.accent,color:THEME.onAccent ?? '#0f172a',display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Montserrat',sans-serif",fontWeight:800,fontSize:16,flexShrink:0}}>{selectedStudent.firstName?.[0]}{selectedStudent.lastName?.[0]}</div>
                    ...
                    {showSktPrompt&&(
                      <div>
                        ...
                        <button onClick={()=>{navigator.clipboard.writeText(aiPrompt);alert('Промпт скопирован!');}}
                          style={{background:THEME.accent,color:THEME.onAccent ?? '#0f172a',border:'none',borderRadius:8,padding:'8px 18px',fontSize:13,fontWeight:600,cursor:'pointer',marginTop:8}}>
                          📋 Копировать промпт
                        </button>
                      </div>
                    )}
