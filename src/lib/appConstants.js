...
export const THEME_LIGHT = { primary:"#0f172a", accent:"#d4af37", onAccent:"#0f172a", onPrimary:"#ffffff", bg:"#f8fafc", surface:"#ffffff", text:"#334155", textLight:"#64748b", border:"#e2e8f0", success:"#10B981", warning:"#F59E0B", error:"#EF4444" };
