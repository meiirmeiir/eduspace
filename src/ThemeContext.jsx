...
const SHOP_THEME_OVERRIDES = {
  galaxy: { primary:'#a78bfa', accent:'#a78bfa', onAccent:'#0f0a1e', onPrimary:'#ffffff', bg:'#0f0a1e', surface:'#1e1b4b', text:'#e2e8f0', textLight:'rgba(226,232,240,0.7)', border:'#312e81' },
  // sakura: ранее primary === bg (оба светло-розовые) — все H1 невидимы.
  // Теперь primary = тёмно-бордовый, читается на любом светло-розовом bg.
  sakura: { primary:'#831843', accent:'#f472b6', onAccent:'#ffffff', onPrimary:'#ffffff', bg:'#fff0f5', surface:'#fce7f3', text:'#831843', textLight:'rgba(131,24,67,0.7)', border:'#fbcfe8' },
  matrix: { primary:'#22c55e', accent:'#22c55e', onAccent:'#0a0f0a', onPrimary:'#ffffff', bg:'#0a0f0a', surface:'#0d1f0d', text:'#22c55e', textLight:'rgba(34,197,94,0.7)', border:'#14532d' },
  fire:   { primary:'#f97316', accent:'#f97316', onAccent:'#1a0a00', onPrimary:'#ffffff', bg:'#1a0a00', surface:'#2d1000', text:'#fed7aa', textLight:'rgba(253,211,170,0.7)', border:'#7c2d12' },
};
